...
<section class="page-hero">
  <div class="wrap">
    ...
    <p class="lede center-narrow">Tsamaya layers a risk model on top of ordinary turn-by-turn routing. Here’s the whole thing, from the moment you pick a destination to the route on your screen.</p>
  </div>
</section>`;
  ...
  <ol class="timeline">
    <li>
      ...
      <div>
        ...
        <p>We start with an ordinary Mapbox route, the same quick line any map app would hand you. That’s the baseline we test against.</p>
      </div>
    </li>
    <li>
    ...
    <li>
      ...
      <div>
        ...
        <p>Follow along with in-app turn-by-turn navigation, or hand off to Google Maps, which we seed with the detour points so it follows the lower-risk line instead of recomputing its own.</p>
      </div>
    </li>
  </ol>`,
});
