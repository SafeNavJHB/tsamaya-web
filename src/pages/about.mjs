...
<section class="page-hero">
  <div class="wrap">
    ...
    <p class="lede center-narrow">Tsamaya started with one driver’s question: <em>why does my map send me through the worst part of town to save two minutes?</em> It grew into a navigation app that puts risk on the map.</p>
  </div>
</section>`;
...
const mission = section({
  ...
  <div class="value-grid">
    ...
    <article class="value">
      ...
      <p>Made in Johannesburg, for the way people actually drive here. It isn’t a global template with our cities bolted onto the side.</p>
    </article>
    <article class="value">
