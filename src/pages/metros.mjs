...
const coveragePage = {
  slug: 'coverage.html',
  title: 'Coverage',
  description: `Tsamaya maps ${fmt(stats.totals.zones)} risk zones across ${stats.totals.metros} South African metros: Johannesburg, Cape Town, Durban, Gqeberha, Pretoria, Ekurhuleni, the West Rand, Stellenbosch, Rustenburg, Pilanesberg, Mossel Bay and Secunda.`,
